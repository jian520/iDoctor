...
export const saveLaunch = async v => {
    await AsyncStorage.setItem(LAUNCH_KEY, JSON.stringify(v))
    return v
}

export const getLaunch = async() => {
    const string = await AsyncStorage.getItem(LAUNCH_KEY)
    return JSON.parse(userString)
}
