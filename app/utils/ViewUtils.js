...
export default class ViewUtils {
    static getSettingSubTitleItem(callBack, icon, text, subText, tintStyle, expandableIco) {
        return (
            <TouchableHighlight
                onPress={callBack}>
                        ...
                        {icon ?
                            <Image source={icon} resizeMode='stretch'
                                   style={[{
                                       ...
                                       height: 16,
                                       marginRight: 10,
                                   }, {tintColor: MPColors.mainColor}]}/> :
                            <View style={{opacity: 1, width: 16, height: 16, marginRight: 10,}}/>
                        }
                        <View>
                            <Text>{text}</Text>
                            <Text style={{color: MPColors.subTitleColor}}>{subText}</Text>
                        </View>
                    </View>
        ...
        return <TouchableHighlight
            ...
            <View style={{paddingRight: 8}}>
                <Image
                    ...
                    source={require('../images/ic_more_vert_white_48pt.png')}
                />
            </View>
        </TouchableHighlight>
    }
